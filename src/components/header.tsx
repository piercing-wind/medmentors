...
export const Header = () => {
  ...
  return (
    <nav className="flex items-center justify-between px-4 md:px-20 my-5 z-50 ">
      <Image
        ...
        height={100}
      />
      <ul className="p-1 border-2 rounded-xl fixed mx-auto  flex md:relative bottom-4 z-50 md:flex items-center gap-10  backdrop-blur-xl">
      <li
      ...
      <Link href="https://certificates.medmentors.in" target="_blank" className="border border-blue-500 rounded-md px-4 py-2">
        Certificates
      </Link>
    </nav>
  );
